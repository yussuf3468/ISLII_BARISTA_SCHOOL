...
/**
 * ISLII runs two numbers, per the course brochures:
 *   · CALLS    0746 487 878
 *   · WHATSAPP 0723 553 153
 * They are deliberately kept separate — sending WhatsApp traffic to the voice
 * line would silently drop every enquiry the form generates.
 */
const PHONE_E164 = '254746487878';
const WHATSAPP_E164 = '254723553153';
